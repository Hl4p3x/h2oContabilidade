...
<!--[if !IE]><!--> <html> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>H2oContabilidade | Contabil</title>
    ...
    <body class="single push-menu">
        ...
        <div id="wrapper">
            ...
            <div class="main">
                ...
                <div class="container">
                    <article class="entry">
                        <h2 class="entry-title">Serviço Contábil H2O.</h2>
                        <div class="entry-meta">
                            <span><i class="fa fa-edit"></i>Por <a>Ronaldo Carvalho</a></span>
                        </div><!-- End .entry-meta -->
                        <div class="entry-content">
                            <div class="mb20"></div>
                            <p>Nosso departamento contábil conta com modernas instalações com a softwares e hardwares de ponta somados a uma equipe técnicade competentes profissionais treinados, motivados, que amam o que faz e estão alinhados às melhores práticas da contabilidade para a sua empresa, com propósito de não somente atender às exigências do FISCO, mas principalmente, tornar os recursos e informações da contabilidade,um eficaz instrumento de gestão empresarial.
