...
<!--[if !IE]><!--> <html> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>H2oContabilidade | Trabalhista e Previdenciário</title>
        ...
        <div id="wrapper">
            ...
            <div class="main">
                <div class="page-header">
                    <div class="container">
                        <h1>Trabalhista e Previdenciário</h1>
                ...
                <div class="breadcrumb-container mb100">
                    <div class="container">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Trabalhista e Previdenciário</li>
                        </ol>
                    </div><!-- End .container -->
                ...
                <div class="container">
                    <article class="entry">
                        <h2 class="entry-title">Serviço Trabalhista e Previdenciário H2O.</h2>
                        <div class="entry-meta">
                            <span><i class="fa fa-edit"></i>Por <a>Ronaldo Carvalho</a></span>
                        </div><!-- End .entry-meta -->
                        <div class="entry-content">
                            <div class="mb20"></div>
                            <p>A assessoria Trabalhista e Previdenciária, através de profissionais treinados para este tipo de atendimento, conta com soluções de tecnologia da informação que simplificam e tornam eficaz, toda a rotina de Folha de Pagamento das empresas, bem como, o cumprimento preciso de todas as obrigações trabalhistas e previdenciárias, tudo isto, sob a orientação de empresas especializadas em informações legais, além de um corpo jurídico formado por escritórios de advocacia parceiros compostos por renomados advogados.</p>
