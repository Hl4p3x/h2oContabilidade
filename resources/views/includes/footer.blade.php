        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div class="widget widget-about">
                    ...
                    <a href="{{ url('quem-somos') }}">Leia Mais</a>
                </div><!-- End .widget -->
            </div><!-- End .col-sm-6 -->
            <div class="col-sm-6 col-md-3">
                <div class="widget widget-popular-posts">
                    ...
                    <ul class="links">
                        ...
                        <li><a href="{{ url('servicos') }}"><i class="fa fa-industry"></i>Serviços</a></li>
                        <li><a href="{{ url('clientes') }}"><i class="fa fa-users"></i>Clientes</a></li>
                        <li><a href="{{ url('quem-somos') }}"><i class="fa fa-user"></i>Quem Somos</a></li>
                        <li><a href="{{ url('localizacao') }}"><i class="fa fa-map-marker"></i>Localização</a></li>
                        <li><a href="{{ url('contato') }}"><i class="fa fa-envelope"></i>Contato</a></li>
                    </ul>
                </div><!-- End .widget -->
            </div><!-- End .col-sm-6 -->
